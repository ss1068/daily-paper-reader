...
method: 提出了OS-BLIND基准测试，通过300个涵盖12个类别和8种应用的真实场景任务，评估智能体在非预期攻击条件下的安全性。
result: "实验显示前沿模型在OS-BLIND上的攻击成功率普遍超过90%，且多智能体协作会因任务分解进一步削弱模型的安全防御能力。"
